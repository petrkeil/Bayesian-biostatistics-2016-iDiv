...
```{r, message=FALSE, fig.width=12, echo=FALSE, eval=FALSE}   
...
- Can you get the predicted values of `mu` out and plot them?
- Is there an autocorrelation in the residuals?
- Can you fit a 2nd-order autoregressive model?
